...
public class ProductsDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Insertar productos
        saveProduct(user1, "Trono de cristal", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(22.99), 21.0, Currency.EUR, 67,
        ...
        saveProduct(user1, "Corona de medianoche", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(22.50), 21.0, Currency.EUR, 98,
        ...
        saveProduct(user1, "La espada de la asesina", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(23.99), 21.0, Currency.EUR, 28,
        ...
        saveProduct(user2, "Heredera de fuego", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(24.99), 21.0, Currency.EUR, 29,
        ...
        saveProduct(user2, "Reina de sombras", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(25.99), 21.0, Currency.EUR, 59,
        ...
        saveProduct(user2, "Imperio de tormentas", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(26.99), 21.0, Currency.EUR, 50,
        ...
        saveProduct(user2, "Torre del alba", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(26.99), 21.0, Currency.EUR, 65,
        ...
        saveProduct(user2, "Reino de cenizas", "Sarah J. Maas", "Fantasia", "Romance",BigDecimal.valueOf(27.99), 21.0, Currency.EUR, 100,
        ...
        saveProduct(user1, "Alas de Sangre", "Rebecca Yarros", "Fantasia", "Dragones",BigDecimal.valueOf(21.99), 21.0, Currency.EUR, 75,
        ...
        saveProduct(user1, "Alas de Hierro", "Rebecca Yarros", "Fantasia", "Dragones",BigDecimal.valueOf(21.99), 21.0, Currency.EUR, 53,
        ...
        saveProduct(user1, "Alas de Onix", "Rebecca Yarros", "Fantasia", "Dragones",BigDecimal.valueOf(21.99), 21.0, Currency.EUR, 25,
        ...
        saveProduct(user2, "Un destino teñido de sangre", "Danielle Jensen", "Alta fantasia", "Vampiros",BigDecimal.valueOf(22.99), 21.0, Currency.EUR, 85,
        ...
        saveProduct(user2, "Una ventana a la oscuridad", "Rachel Gilling", "Alta fantasia","Drama", BigDecimal.valueOf(21.99), 21.0, Currency.EUR, 32,
        ...
        saveProduct(user2, "Una corte de rosas y espinas", "Jennifer Armentrout", "Romantasy","Faes", BigDecimal.valueOf(15.99), 21.0, Currency.EUR, 83,
        ...
        saveProduct(user2, "Una corte de niebla y furia", "Jennifer Armentrout", "Romantasy","Faes", BigDecimal.valueOf(16.99), 21.0, Currency.EUR, 47,
        ...
        saveProduct(user2, "Una corte de alas y ruina", "Jennifer Armentrout", "Romantasy", "Faes",BigDecimal.valueOf(17.99), 21.0, Currency.EUR, 85,
        ...
        saveProduct(user2, "Una corte de hielo y estrellas", "Jennifer Armentrout", "Romantasy", "Faes",BigDecimal.valueOf(16.99), 21.0, Currency.EUR, 39,
        ...
        saveProduct(user2, "Fabricante de lagrimas", "Erin Doom", "Romantasy","Faes", BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 27,
        ...
        saveProduct(user1, "El ciclo del roble y el acebo", "K.A. Linde", "Romantasy", "Dioses",BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 46,
        ...
        saveProduct(user1, "El cortejo de Bristol Keats", "JMary E. Pearson", "Romantasy", "Historia",BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 23,
        ...
        saveProduct(user1, "Los juegos de los dioses", "Abigail Owen", "Fantasia","Dioses", BigDecimal.valueOf(19.99), 21.0, Currency.EUR, 100,
        ...
        saveProduct(user1, "Phantasma", "Kaylie Smith", "Drama","Suspense", BigDecimal.valueOf(19.99), 21.0, Currency.EUR, 100,
        ...
        saveProduct(user1, "Sin corazon", "Marissa Meyer", "Fantasia","Romance", BigDecimal.valueOf(20.99), 22.0, Currency.USD, 60,
