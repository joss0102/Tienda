...
public class ProductsDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        saveProduct(user2, "Un destino teñido de sangre", "Danielle Jensen", "Alta fantasia", "Vampiros",BigDecimal.valueOf(22.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user2, "Una ventana a la oscuridad", "Rachel Gilling", "Alta fantasia","Drama", BigDecimal.valueOf(21.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user2, "Fabricante de lagrimas", "Erin Doom", "Romantasy","Faes", BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user1, "El ciclo del roble y el acebo", "K.A. Linde", "Romantasy", "Dioses",BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user1, "El cortejo de Bristol Keats", "JMary E. Pearson", "Romantasy", "Historia",BigDecimal.valueOf(18.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user1, "Los juegos de los dioses", "Abigail Owen", "Fantasia","Dioses", BigDecimal.valueOf(19.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user1, "Phantasma", "Kaylie Smith", "Drama","Suspense", BigDecimal.valueOf(19.99), 21.0, Currency.EUR, 7,
        ...
        saveProduct(user1, "Sin corazon", "Marissa Meyer", "Fantasia","Romance", BigDecimal.valueOf(20.99), 22.0, Currency.USD, 7,
